  ...
  return (
    <main>
      <Flex gap="3em" align="center" direction="column">
        <Flex w={'75%'} gap="lg" justify="space-between" align="center" direction="row" wrap="wrap">
          <Flex
          ...
          <Box w={'50%'}>
            <Spoiler maxHeight={120} showLabel="Show more" hideLabel="Hide">
              <Text size="xl">
                ...
                documentation for the GraphQL API. This documentation can be viewed directly in the
                GraphiQL interface, allowing developers to quickly and easily understand the
                ...
                Another advantage of GraphiQL is its support for multiple programming languages and
                frameworks. It can be used with JavaScript, Python, Ruby, Java, and many other
                ...
                features, and flexibility make it an essential tool for developers who want to work
                more efficiently and effectively with GraphQL APIs.
              </Text>
            </Spoiler>
          </Box>
        </Flex>
        <Flex w={'75%'} gap="xl" justify="space-between" align="center" direction="row">
          <UserCards />
        </Flex>
      </Flex>
    </main>
